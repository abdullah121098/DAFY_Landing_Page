            ...
            if(isset($_POST['sub']))
{
                ...
                $sql="UPDATE `review` SET `log_img`='$img_name' WHERE `name`='$session'";
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="inputEmail4" value="<?php echo $view['name']; ?>" name="user">
                                </div>
                                 <div class="form-group col-md-6">
...
$d=$_POST['address']; $e=$_POST['city']; $f=$_POST['loc'];
   $sql ="UPDATE `review` SET `name`='$a',`email`='$b' WHERE `name`='$a'AND `log_mail`='$b'";
