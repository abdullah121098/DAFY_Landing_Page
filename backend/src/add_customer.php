                ...
                <div class="card-body">
                    ...
                    <form class="form-sample" method="POST" onsubmit="showConfirmation()">
                        ...
                        <div class="row g-1 m-1">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <button type="submit" class="col-sm-3 btn btn-success px-4 py-3" name="add-data">Book Now</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<?php
    ...
    //             '$date','$time','$vechile','$vechiletype')");
    //                 if($st){
    //                     echo '<script>alert("New Schedule Booking Added");</script>';
    //                 }else{ echo '<script>alert("Booking Failed!");</script>'; }
    //         break;
    //         case 'immediate_trip':
    ...
    //             `payment_type`, `payment`, `status`) VALUES
    //             ('$name','$mail',' $mobile',' $current','$destination',' $trip','$schedule',
    //             '$currentDate','$currentTime','$vechile','$vechiletype')");
    //                 if($it){
    //                     echo '<script>alert("New Immediate Booking Booking Added");</script>';
    //                 }else{ echo '<script>alert("Booking Failed!");</script>'; }
...
if(isset($_POST['add-data'])){
    ...
    $currentDate = date('d-m-Y');
    $currentTime = date(localtime("h:i:a"));
    ...
    switch ($schedule) {
        case 'schedule_trip':
            $st=mysqli_query($conn,
                ...
                `payment_type`, `payment`, `status`) VALUES
                ('$name','$mail','$mobile','$current','$destination','$trip','$schedule',
                '$date','$time','$vechile','$vechiletype','$driver',
