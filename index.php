                        ...
                        <div class="container">
                            ...
                            <div class="owl-carousel testimonial-carousel wow fadeInUp h-50" data-wow-delay="0.1s" >
                                        ...
                                        <div class="team-item overflow-hidden pb-4 rounded p-lg-5 mb-5">
                                            <img class="mb-4" src="assert/img/team/ceo1.jpg" alt="">
                                            <h5>Manikandan Ak</h5>
                                        ...
                                        <!--/div-->
                                            ...
                                            <div class="team-item overflow-hidden pb-4 rounded p-lg-5 mb-5">
                                            <img class="mb-4" src="assert/img/team/team-5.jpg" alt="">
                                        ...
                                        <div class="team-item overflow-hidden pb-4 rounded p-lg-5 mb-5">
                                            ...
                                            <div class="team-item overflow-hidden pb-4 rounded p-lg-5 mb-5">
                                                <img class="mb-4" src="assert/img/team/account.jpg" alt="">
                                                <h5>Stephin Jose</h5>
                                                <span class="text-warning">Accounts Head</span>
