                    ...
                    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" >
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="w-100" src="img/slider/welcome-to-dafy1.png" alt="Image" height="800px">
                                    ...
                                    <div class="container">
                                        <div class="row justify-content-end">
                                            ...
                                            <div class="col-lg-7 text-end col-10 ">
                                                ...
                                                <a href="" class="btn btn-warning rounded-pill py-3 px-5 animated slideInDown"style="font-family: 'Lato', sans-serif;">
                                                    Read More</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="carousel-item">
                                <img class="w-100" src="img/slider/your-car-our-driver.jpg" alt="Image" height="800px">
                                <div class="carousel-caption">
                                    <div class="container">
                                        <div class="row  justify-content-end">
                                            <div class="col-lg-7 text-end col-10">
                                                ...
                                                <a href="" class="btn btn-warning rounded-pill py-3 px-5 animated slideInUp"style="font-family: 'Lato', sans-serif;">
                                                    Read More</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="carousel-item">
                                <img class="w-100" src="img/slider/navigation.jpg" alt="Image" height="800px">
                                <div class="carousel-caption">
                                    <div class="container">
                                        <div class="row justify-content-end">
                                            <div class="col-lg-7 text-end col-10">
                            ...
                            <div class="carousel-item">
                                <img class="w-100" src="img/slider/luxury-car3.png" alt="Image" height="800px" >
                                <div class="carousel-caption">
                                    <div class="container">
                                        <div class="row justify-content-end">
                            ...
                            <div class="carousel-item">
                                <img class="w-100" src="img/slider/Dafy-Banner-03.png" alt="Image" height="800px">
                                <div class="carousel-caption">
                                    <div class="container">
                                        <div class="row justify-content-end">
                                            <div class="col-lg-7 text-end">
                            ...
                            <div class="carousel-item">
                                <img class="w-100" src="img/slider/stan.jpg" alt="Image" height="800px">
                                <div class="carousel-caption">
                                    <div class="container">
                                        <div class="row justify-content-end">
                                            <div class="col-lg-7 text-end">
                            ...
                            <div class="carousel-item">
                                <img class="w-100" src="img/slider/8.png" alt="Image" height="800px">
                                <div class="carousel-caption">
                                    <div class="container">
                                        <div class="row justify-content-end">
                                            <div class="col-lg-7 text-end">
                                                ...
                                                <h1 class="display-1 text-white mb-5 animated slideInLeft"style="font-family: 'Lato', sans-serif;">
                                                    ...
                                                    <a href=""
                                                    class="btn btn-warning rounded-pill py-3 px-5 animated slideInLeft" data-bs-toggle="modal" data-bs-target="#book3">
                                                Book now
                                                </a>
                                                <a href=""
                                                    class="btn btn-warning rounded-pill py-3 px-5 animated slideInLeft"
